 ...
 * held-out protocol v2.1 in full 512-d geometry (n=296, 2026-08, gallery 1150
 * after 6.5.72 extras): refit via scripts/refit-calibration.ts, deterministic.
 ...
 */
export const CALIBRATION_VERSION = "adaface-ir101-logistic-512d-2026-08-v4";
